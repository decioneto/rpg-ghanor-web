...
export function Select({ itens, onChange }: SelectProps) {
    return (
        <SelectRadix.Root onValueChange={onChange}>
            <SelectRadix.Trigger className="flex items-center justify-between py-3 px-4 bg-ghanor-yellow-700 rounded text-ghanor-yellow-100 font-title border text-left outline-none">
